			...
			<div class="row">
				<div class="col-sm-5 mx-auto">
					<form method="POST">
						<div class="mb-3 mt-3">
							<label class="form-label">ID</label>
							<input type="text" name="id_peminjaman" placeholder="masukkan id_peminjaman" 
							required class="form-control col-form-label-sm">
						</div>
						<div class="mb-3">
							<label class="form-label">Tanggal Peminjaman</label>
							<input type="date" name="tgl_pinjam" placeholder="masukkan tgl_pinjam" 
							required class="form-control col-form-label-sm">
						</div>
						<div class="mb-3">
							<label class="form-label">Tanggal Kembali</label>
							<input type="date" name="tgl_kembali" placeholder="masukkan tgl_kembali" 
							required class="form-control col-form-label-sm">
						</div>
						<div class="mb-3">
							<label class="form-label">Pilih ID Member</label>
							<select class="form-select form-control" id="id_member" name="id_member" required>
								...
								$result = selectalldata("member");
								while ($row = mysqli_fetch_array($result)) {
									echo '<option value=' . $row['id_member'] . '>' . $row['id_member'] . ' - ' . 
